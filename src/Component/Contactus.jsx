...
import contactApi from '../config/Contactapi';
...
const Contactus = () => {
    ...
    const onSubmit = (data) => {
        ...
        alert(`Name: ${data.name}, Email: ${data.email}, Contact Number: ${data.contactNumber}, Message: ${data.message}`);
    };
                    ...
                    <div className='col-lg-6 col-12 mt-3 mt-md-0 py-4'>
                        <form onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <div className="form-group my-4">
                                <input
                                    type="text"
                                    className={`form-control ${errors.subject ? 'is-invalid' : ''} py-3`}
                                    id="subject"
                            ...
                            <div className="form-group my-4">
                                <textarea
                                    className={`form-control ${errors.message ? 'is-invalid' : ''} py-3`}
                                    id="message"
                            ...
                            <div className='row flex-column flex-md-row  align-items-center'>
                                <div className='col-md-4 text-start'>
                                    <button type="submit" className="btn btn-primary mt-1 py-2 px-5  fw-semibold">
                                        Send
                                    </button>
                                </div>
